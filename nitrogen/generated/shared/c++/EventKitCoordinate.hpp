...
namespace margelo::nitro::eventkitx {
   ...
   */
  struct EventKitCoordinate final {
  public:
  ...
  public:
    friend bool operator==(const EventKitCoordinate& lhs, const EventKitCoordinate& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::eventkitx::EventKitCoordinate> final {
    static inline margelo::nitro::eventkitx::EventKitCoordinate fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::eventkitx::EventKitCoordinate(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::eventkitx::EventKitCoordinate& arg) {
